...
if (isset($_POST['username'], $_POST['email'], $_POST['p'], $_POST['languageId'])) {
    ...
    $chLang     = filter_input(INPUT_POST, 'chLang', FILTER_SANITIZE_STRING);
    $admin      = filter_input(INPUT_POST, 'admin', FILTER_SANITIZE_STRING);
    $languageId = filter_input(INPUT_POST, 'languageId', FILTER_SANITIZE_STRING);
    $editMenu   = filter_input(INPUT_POST, 'editMenu', FILTER_SANITIZE_STRING);
    ...
    $prep_stmt = "SELECT id FROM 1_members WHERE email = ? LIMIT 1";
   ...
   // check existing email  
    ...
    $prep_stmt = "SELECT id FROM 1_members WHERE username = ? LIMIT 1";
    //$stmt = $members_mysqli->prepare($prep_stmt);  //{PT}
    $stmt = $mysqli->prepare($prep_stmt);
